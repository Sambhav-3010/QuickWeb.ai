...
export function TerminalPanel({ logs }: TerminalPanelProps) {
    ...
    return (
        <div className="h-[50%] w-[80%] bg-[#2D2926] flex flex-col text-sm rounded-xl border border-border/30 organic-shadow">
            <div className="flex-none flex items-center px-4 h-10 select-none">
                <div className="flex gap-1.5 opacity-70 hover:opacity-100 transition-opacity">
                    <div className="w-3 h-3 rounded-full bg-[#C67C4E]" />
                    <div className="w-3 h-3 rounded-full bg-[#D4A574]" />
                    <div className="w-3 h-3 rounded-full bg-[#8B9D83]" />
                </div>
                <span className="ml-3 text-base text-[#F5F1EB]/70 font-mono font-medium">Terminal</span>
            </div>
            <div className="h-[1px] w-full bg-[#F5F1EB]/20"></div>
            <div className="flex-1 min-h-0 relative">
                ...
                >
                    <div className="p-4 font-mono text-[#F5F1EB]/80 whitespace-pre-wrap leading-relaxed">
                        {processLogs()}
